...
.ciclo:
	...
	cvtdq2ps xmm10, xmm10 ;|j|j|j|j en floats
	divps xmm10, xmm12 ; |j/cols|j/cols|j/cols|j/cols
	mulps xmm10, xmm15 ;|(j/cols)*255,0|(j/cols)*255,0|(j/cols)*255,0|(j/cols)*255,0
	cvttps2dq xmm10, xmm10 ;|(j/cols)*255,0|(j/cols)*255,0|(j/cols)*255,0|(j/cols)*255,0 ints
	pxor xmm10, xmm9 ;|+|+|+|+
	...
	add r12d, 4
	movd xmm1, r12d ; |*|*|*|j
	shufps xmm1, xmm1, 0; |j|j|j|j
	cvtdq2ps xmm1, xmm1 ;|j|j|j|j en floats
	divps xmm1, xmm12 ; |j/cols|j/cols|j/cols|j/cols
	mulps xmm1, xmm15 ;||(j/cols)*255,0|(j/cols)*255,0|(j/cols)*255,0|(j/cols)*255,0
	cvttps2dq xmm1, xmm1 ;|(j/cols)*255,0|(j/cols)*255,0|(j/cols)*255,0|(j/cols)*255,0 ints
	pxor xmm1, xmm9
	...
	cvtdq2ps xmm2, xmm2 ;|j|j|j|j en floats
	divps xmm2, xmm12 ; |j/cols|j/cols|j/cols|j/cols
	mulps xmm2, xmm15 ;|(|(j/cols)*255,0|(j/cols)*255,0|(j/cols)*255,0|(j/cols)*255,0
	cvttps2dq xmm2, xmm2 ;|(j/cols)*255,0|(j/cols)*255,0|(j/cols)*255,0|(j/cols)*255,0 ints
	pxor xmm2, xmm9
	...
	cvtdq2ps xmm3, xmm3 ;|j|j|j|j en floats
	divps xmm3, xmm12 ; |j/cols|j/cols|j/cols|j/cols
	mulps xmm3, xmm15 ;||(j/cols)*255,0|(j/cols)*255,0|(j/cols)*255,0|(j/cols)*255,0
	cvttps2dq xmm3, xmm3 ;|(j/cols)*255,0|(j/cols)*255,0|(j/cols)*255,0|(j/cols)*255,0 ints
	pxor xmm3, xmm9
